...
<div class="login-wrap">
  <div class="login-card">
    ...
    <p class="sub">Credentials: <b style="color:#1a4c6e"><br>the0x:attacker<br>
        <span style="color: red;">Note: You are required to change the administrator password and log in using that
          account.</span>
    </p>
