...
<div class="login-wrap">
  <div class="login-card">
    ...
    <p class="sub">Credentials: <b style="color:#1a4c6e"><br>administrator:admin<br>the0x:attacker<br>
        <span style="color: red;">Note: You are required to bypass two-factor authentication and log in to the
          administratro account.</span>
    </p>
