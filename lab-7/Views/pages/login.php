...
<div class="login-wrap">
  <div class="login-card">
    ...
    <p class="sub">Credentials: <b
        style="color:#1a4c6e"><br>administrator:admin<br>the0x:attacker<br>ahmed:ahmed123</b><br>
      <span style="color: red;">Note: Use the administrator account to upgrade the attacker's account via the 'ahmed'
        account.</span>
    </p>
